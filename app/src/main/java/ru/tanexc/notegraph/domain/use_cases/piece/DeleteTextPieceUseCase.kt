...
class DeleteTextPieceUseCase @Inject constructor(
    private val repository: NoteRepository
) {
    operator fun invoke(noteId: String, textPiece: TextPiece): Flow<Action<Unit>> = repository.deleteTextPiece(noteId, textPiece)
}